    ...
    */
    ...
    pub fn new_default_meta(owner_id: AccountId) -> Self {
        ...
        Self::new(
            owner_id,
            NFTContractMetadata {
                spec: "nftvolunteer-0.0.1".to_string(),
                name: "NFT Support Ukraine Volunteers contract".to_string(),
                symbol: "NFTVOLUNTEER".to_string(),
                icon: None,
                base_uri: None,
                reference: None,
                reference_hash: None,
